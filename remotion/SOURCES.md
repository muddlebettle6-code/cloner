# Cumulant Reel — Sources & Asset Licenses
...
Note: of the two approved fonts, the v2 reel uses **Neue Haas Unica** only (big display text); Akkurat Mono remains available but is not used in this cut.

No copyrighted clips, stock montage, or another publication's branded graphics were used.
No image of a real person was created or altered.
